...
- **JWT:** Carries the user ID and role for 15 minutes after login. A rotated refresh token in an HttpOnly cookie renew a access and can be revoked on logout or password change.
